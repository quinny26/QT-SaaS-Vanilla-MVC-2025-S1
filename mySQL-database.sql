...
-- BEFORE COMMENCING:
--
-- - Replace all instances of 2025 with the current year (e.g. 2025)
-- - Replace all instances of S1 with S followed by the semester number (e.g. S1 for semester 1)
-- - Replace ALL instances of QT with your initials (e.g. AJG for Adrian Gould)
--
-- ---------------------------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------------------  
DROP TABLE IF EXISTS `QT_saas_vanilla_mvc`.`users`;

-- ----------------------------------------------------------------------------------------  
-- Table structure for 'users' table  
-- ----------------------------------------------------------------------------------------  
CREATE TABLE IF NOT EXISTS `QT_saas_vanilla_mvc`.`users`
(
